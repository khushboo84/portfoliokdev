  ...
  return (
    <div className=" py-32  " id="contact">
      <div className="px-20 lg:px-32 xl:px-[250px] lg:text-xl xl:text-2xl">
        ...
        {/* message */}
        <div className="max-lg:text-center font-semibold py-10">
        ...
        <ul className="flex flex-col-2 gap-8 pt-6 max-lg:justify-center max-lg:items-center">
          <li>
            <div className="flex justify-center items-center max-lg:text-center ">
              ...
              >
                <AiOutlineInstagram className="bg-primary text-6xl p-1 rounded-full shadow-xl " />
              </a>
          ...
          <li>
            <div>
              <a href="mailto:khushboochauhan840@gmail.com">
                <AiFillMail className=" bg-primary text-6xl p-2 rounded-full shadow-xl" />
              </a>
            </div>
          </li>
        </ul>
        {/* like section */}
        <div className="max-lg:text-center py-10 max-lg:px-10">
        ...
        >
          <AiOutlineHeart className="bg-primary fill-secondary text-6xl p-1 rounded-full shadow-xl " />
        </form>
      </div>
    </div>
  );
